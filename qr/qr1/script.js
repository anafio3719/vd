...
function init() {
  ...
  add.addEventListener('click', () => {
    content.insertBefore(createQR('https://github.com/aiuokp3150/www/blob/master/README.md?d#1'), add)
  });
  ...
  let localQr = JSON.parse(localStorage.getItem('_local_qr_codes_') || '["https://github.com/aiuokp3150/www/blob/master/README.md?d#1"]');
